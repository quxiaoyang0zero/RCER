...
#val 1:50
print("val")
val_set = pd.read_csv('nyc_u_i_val_set.csv',delimiter=",")
print(val_set.shape)
...
data.to_csv('nyc_u_i_val_set_neg.csv', index=0)
print("end")


# #test 1:50
# print("test")
# test_set = pd.read_csv('nyc_u_i_test_set.csv',delimiter=",")
...
#     datau=datau.sample(frac=1).reset_index(drop=True)
#     data = pd.concat((data,datau),axis = 0)
# data.to_csv('nyc_u_i_test_set_neg.csv', index=0)
# print("end")


# #train 1:4
# print("train")
# train_set = pd.read_csv('nyc_u_i_train_set.csv',delimiter=",")
...
# data.to_csv('nyc_u_i_train_set_neg.csv', index=0)



#nohup python -u make_dataset.py > make_dataset_train.txt 2>&1 &
#nohup python -u make_dataset.py > make_dataset_test.txt 2>&1 &
#nohup python -u make_dataset.py > make_dataset_val.txt 2>&1 &
